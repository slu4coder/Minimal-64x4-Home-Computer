# Cycle-exact Minimal 64x4 Emulator (C++/OpenGL)

PLEASE NOTE: The FLASH image file 'flash.bin' (see section 'Revision .../FLASH Images') needs to reside in the same directory as the emulator.
